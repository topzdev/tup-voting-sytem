import {
  ...
  export const validationMessages: Record<ValidationIds, SettingsValidation> = {
    ["no-voters"]: {
      severity: "error",
  ...
  export const launchpadValidationChecker = (data: SettingsValidationData) => {
    const {
      votersCount,
      partiesCount,
      positionsCount,
    ...
    let validations: SettingsValidation[] = [];
